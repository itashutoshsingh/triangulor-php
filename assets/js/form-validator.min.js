    ...
    var c = ':input:not([type="submit"], button):enabled:visible',
        d = function (b, c) {
            ...
            a.extend(d.VALIDATORS, c.custom),
                ...
                this.$element.on("submit.bs.validator",
                    a.proxy(this.onSubmit, this)),
                this.$element.find("[data-match]").each(function () {
                    var b = a(this),
                        c = b.data("match");
                    a(c).on("input.bs.validator",
                        function () { b.val() && b.trigger("input.bs.validator") })
                })
        }; d.DEFAULTS = {
            delay: 500,
            html: !1,
            ...
            d.prototype.runValidators = function (b) {
                ...
                return b.data("bs.validator.deferred") && b.data("bs.validator.deferred").reject(),
                    ...
                    !e.length && b.val() && b.data("remote") ? this.defer(b, function () {
                        ...
                        d[b.attr("name")] = b.val(),
                            a.get(b.data("remote"),
                                d).fail(function (a, b, d) { e.push(c("remote") || d) }).always(function () {
                                    f.resolve(e)
                                })
                    }) : f.resolve(e),
                    f.promise()
                ...
                this.defer(b, function () {
                    ...
                    g.length && (g = a("<ul/>").addClass("list-unstyled").append(a.map(g,
                        function (b) {
                            return a("<li/>")[c](b)
                        })),
                        void 0 === e.data("bs.validator.originalContent") && e.data("bs.validator.originalContent",
                            e.html()),
                        e.empty().append(g),
            ...
            d.prototype.toggleSubmit = function () {
                ...
                return c = a.proxy(c, this),
                    this.options.delay ? (window.clearTimeout(b.data("bs.validator.timeout")),
                        void b.data("bs.validator.timeout",
                            window.setTimeout(c, this.options.delay))) : c()
            },
